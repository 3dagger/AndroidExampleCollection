package com.dagger.navermapclustering.clustering.ui
...
internal class IconGenerator(private val mContext: Context) {
	...
	private val mContainer: ViewGroup = LayoutInflater.from(mContext).inflate(R.layout.amu_text_bubble, null) as ViewGroup
